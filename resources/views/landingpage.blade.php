...
<div id="head" class="template-header-bottom" style="color: white!important;">
		...
		<div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
			<ul>
				...
				<li data-index="slide-1" data-transition="fade" data-slotamount="1" data-easein="default" data-easeout="default" data-masterspeed="500" data-rotate="0" data-delay="6000">
					<!-- Main image -->
					<img src="media/image/slider/carwash.jpg" alt="slide-1" data-bgfit="cover" data-bgposition="center bottom">
					<!-- Layers -->
					<!-- Layer 01 -->
...
<li data-index="slide-2" data-transition="fade" data-slotamount="1" data-easein="default" data-easeout="default" data-masterspeed="500" data-rotate="0" data-delay="6000">
	<!-- Main image -->
	<img src="media/image/slider/carwash.jpg" alt="slide-2" data-bgfit="cover" data-bgposition="center bottom">
	<!-- Layers -->
	<!-- Layer 01 -->
	<div class="tp-caption tp-resizeme" 
	data-x="['center','center','center','center','center']" data-hoffset="['0','0','0','0','0']" 
...
<li data-index="slide-3" data-transition="fade" data-slotamount="1" data-easein="default" data-easeout="default" data-masterspeed="500" data-rotate="0" data-delay="6000">
	<!-- Main image -->
	<img src="media/image/slider/carwash.jpg" alt="slide-3" data-bgfit="cover" data-bgposition="center bottom">
	<!-- Layers -->
	<!-- Layer 01 -->
	<div class="tp-caption tp-resizeme" 
	data-x="['center','center','center','center','center']" data-hoffset="['0','0','0','0','0']" 
...
<!-- Content -->
<div id="about" class="template-content">
	...
	<div class="template-section template-section-padding-1 template-clear-fix template-main">
		...
		<div class="template-component-header-subheader">
			<h2 style="color: #183861;">About us</h2>
			<div></div>
		...
		<div class="template-layout-33x66 template-clear-fix">
			...
			<div class="template-layout-column-left">
				<img style="width:460px!important ; height:480px!important ;" src="media/image/sample/460x678/image_01.jpg" alt=""/>
			</div>
			...
			<div class="template-layout-column-right">
				...
				<p class="template-padding-reset">
					Swipi car wash is an eco-friendly, hand car wash and detailing service based in Singapore. 
					Our company was founded back in 2018 by a team of experts with more then 10 years of professional car wash experience. 
					We operate with a very unique concept of helping you get your service at your door step in singapore area. Our goal is to provide our customers with the friendliest, most convenient 
					...
					<ul class="template-layout-50x50 template-clear-fix">
						...
						<li class="template-layout-column-left template-margin-bottom-reset">
							...
							<ul class="template-component-list">
								...
								<li><span class="template-icon-meta-check"></span>Multiple car wash locations throughout Singapore</li>
	...
	<!-- Section -->
	<div style="background-color: #183861!important;" class="template-section template-background-image-5 template-background-image-parallax template-color-white template-clear-fix">
	...
	<!-- Section -->
	<div id="services" class="template-section template-section-padding-1 template-clear-fix template-main">
	...
	<!-- Section -->
	<div id="contactus" class="template-section template-section-padding-1 template-clear-fix template-main">
		...
		<div class="template-component-feature-list template-component-feature-list-position-left template-clear-fix">
			...
			<ul class="template-layout-33x33x33 template-clear-fix">
				...
				<li class="template-layout-column-left">
					...
					<h5 style="color: blue">Call Us At</h5>
					<p>
						(+505) 122 225 225<br/>
						(+505) 122 225 224<br/>
					</p>
				...
				<li class="template-layout-column-right">
					...
					<h5 style="color: blue">Working hours</h5>
					<p>
	...
	<div class="template-main">
		...
		<div class="template-footer-top">
			...
			<div class="template-layout-25x25x25x25 template-clear-fix">
				...
				<div class="template-layout-column-left">
					<h6>About</h6>
					<p>Autospan Hand Wash is an eco-friendly hand car wash and detailing service based in Singapore.</p>
				...
				<div class="template-layout-column-center-left">
					...
					<ul class="template-list-reset">
						...
						<li><a href="/">Tower Hand Dry</a></li>
						<li><a href="/">Tire Dressing</a></li>
						<li><a href="/">Wheel Shine</a></li>
						<li><a href="/">Interior Vacuum</a></li>
						<li><a href="/">Sealer Hand Wax</a></li>
					</ul>									
				</div>
				...
				<div class="template-layout-column-center-right">
					...
					<ul class="template-list-reset">
						...
						<li><a href="tnc.php">Term & Condition</a></li>
		...
		<div class="template-footer-bottom">
			...
			<div class="template-footer-bottom-copyright">
				By <a href="http://quanticalabs.com" target="_blank">swipe</a> &copy; 2016 <a href="http://themeforest.net/user/QuanticaLabs/portfolio?ref=quanticalabs" target="_blank"></a>
			</div>
